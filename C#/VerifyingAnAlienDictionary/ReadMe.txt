...
Space        O(N) 
Time         O(N^2)
Description  Save alphabet order in a dictionary, and verify each word follows the order           
************************************************************************************************/
...
public class Solution {
    ...
    public bool IsValid(string a_str, string b_str, Dictionary<char,int> dict)
    {
